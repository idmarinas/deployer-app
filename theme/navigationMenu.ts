...
export default {
	slots: {
		root: 'relative',
		list: 'flex flex-col gap-0.5 pcb-panel-grid rounded-md p-1',
		item: 'relative',
		link: [
		...
		linkActive: [
			...
			'shadow-[inset_0_0_12px_color-mix(in_srgb,var(--color-deployer-primary-500)_8%,transparent)]',
		].join(' '),
		linkLeadingIcon: 'size-4 shrink-0 transition-colors duration-200',
		linkLeadingIconActive: 'text-primary-500 dark:text-primary-400 drop-shadow-[0_0_6px_var(--pcb-trace-glow)]',
		...
		childLinkActive: [
			...
			'before:bg-primary-500 before:shadow-[0_0_4px_var(--pcb-trace-glow)]',
		].join(' '),
	},
}
