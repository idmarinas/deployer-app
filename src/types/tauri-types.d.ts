...
export type AppInfo = { name: string, version: string, identifier: string, description: string, copyright: string, publisher: string, tauri_version: string, platform: string, architecture: string, };
