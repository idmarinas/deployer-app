...
export default {
	...
	files: {
		...
		relative_hint:
			'Rutas relativas a remote_path. El archivo compose.yaml se gestiona automáticamente desde el formulario.',
		edit: 'Editar',
		delete: 'Eliminar',
		empty: 'No hay archivos definidos',
		select_hint: 'Selecciona un archivo del árbol para editarlo',
		compose_readonly: 'El contenido de compose.yaml se gestiona en la pestaña compose.yaml',
