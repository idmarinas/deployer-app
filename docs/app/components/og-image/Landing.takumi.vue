...
<template>
	<div class="flex flex-col justify-center w-full h-full bg-blue-950 p-25">
		<svg
			class="absolute right-0 top-0 fill-blue-200"
			height="593"
			viewBox="0 0 629 593"
			width="629"
		...
		<div class="flex flex-row gap-5">
			<div class="flex-1 flex flex-col justify-center items-start">
				...
				<h1
					v-if="title"
					class="w-150 m-0 text-[75px] font-semibold mb-4 text-white"
			...
			<div class="w-85 flex flex-col items-center justify-center gap-0 text-blue-300 dark:text-blue-900">
				...
				<SvgRocket class="opacity-65" height="340" width="340" />
